...
function CanvasScaler({ children, innerRef }: { children: React.ReactNode; innerRef?: React.Ref<HTMLDivElement> }) {
  ...
  return (
    <div style={{ width: 1080 * scale, height: 1300 * scale }} className="relative">
      <div
        ref={innerRef}
        style={{
...
function Canvas({ tiers, slots, onUpdateSlot, dateText }: { tiers: Tier[]; slots: SlotsMap; onUpdateSlot: SlotUpdater; dateText: string }) {
  return (
    ...
    >
      ...
      {[
        { x: 120, y: 1095, r: 20, s: 0.7, o: 0.55 },
        { x: 260, y: 1135, r: -35, s: 0.55, o: 0.45 },
        { x: 820, y: 1110, r: 48, s: 0.6, o: 0.5 },
        { x: 940, y: 1145, r: -12, s: 0.5, o: 0.45 },
        { x: 60, y: 1150, r: 65, s: 0.45, o: 0.4 },
      ].map((pt, i) => (
        <img
          key={`f${i}`}
          src={petal.url}
